...
-- aggiunge spazio tra le finestre
...
--                                     menu = mymainmenu })
mylauncher = awful.widget.launcher({ image = "/usr/share/awesome/themes/default/ico.png",
                                     menu = mymainmenu })
...
globalkeys = gears.table.join(
    ...
    -- serve per settare i monitor
    -- awful.key({}, "l", function() xrandr.xrandr() end),
    ...
    awful.key({ modkey,           }, "b",     function () awful.spawn(browser)          end,
              {description = "avvia chromium", group = "layout"}),

    -- Avvio di Gui Editor
    awful.key({ modkey,           }, "v",     function () awful.spawn(gui_editor)          end,
              {description = "avvia vs code", group = "layout"}),
...
clientkeys = gears.table.join(
    ...
    -- quando la finestra viene messa in floating
    -- viene anche messa ontop
...
awful.rules.rules = {
   ...
   --   properties = { shape = gears.shape.rounded_rect } },
    ...
    --{ rule = { class = "termite" },
    --   properties = { titlebars_enabled = false , opacity = 0.8 } },
}
-- }}}
...
-- Autostart
-- xrandr va fatto eseguire per primo
